...
class Text(object):
	GREET_USER = "Hello {}!\nI am REIGNZ Mirror Bot V2.0 Made By @Reignz3.This bot is an original fork of GDrive Mirror Bot developed by @atulsingh. Just send me any direct download link and I'll send you the GDrive Mirror of that file.\nNot only this, I can send you the GDrive link of YouTube videos and even can extract high quality audio from them.\n\nUse /help command to get started."
	...
	MAXLIMITEXCEEDED = "Maximium file limit exceeded.\nTry sending file with filesize less than 250GB."
